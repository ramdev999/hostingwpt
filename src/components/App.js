...
import { addToDb } from '../saveToDb';

function calc(state) {
  console.log('Hello');
  console.log(state);
  let arrayData = state.a1?.concat(state.a2, state.a3, state.a4, state.a5);
  addToDb(arrayData).then((data) => {
